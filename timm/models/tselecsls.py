...
__all__ = ['TSelecSLS']  # model_registry will add each entrypoint fn to this
...
default_cfgs = {
    ...
    'se_tselecsls42': _cfg(
        url='',
        interpolation='bicubic'),
    'se_tselecsls42b': _cfg(
        url='',
        interpolation='bicubic'),
    'se_tselecsls60': _cfg(
        url='',
        interpolation='bicubic'),
    'se_tselecsls60b': _cfg(
        url='',
        interpolation='bicubic'),
}
...
def _create_model(variant, pretrained, model_kwargs):
    cfg = {}
    if variant.startswith('tselecsls42'):
        ...
        cfg['features'] = [
            ...
            (32, 0, 64, 64, True, 2, False),
            (64, 64, 64, 128, False, 1, False),
            (128, 0, 144, 144, True, 2, False),
    ...
    elif variant.startswith('tselecsls60'):
        cfg['block'] = SelecSLSBlock
        # Define configuration of the network after the initial neck
        cfg['features'] = [
            # in_chs, skip_chs, mid_chs, out_chs, is_first, stride
            (32, 0, 64, 64, True, 2, False),
            (64, 64, 64, 128, False, 1, False),
            (128, 0, 128, 128, True, 2, False),
            (128, 128, 128, 128, False, 1, False),
            (128, 128, 128, 288, False, 1, False),
        ...
        if variant == 'tselecsls60b':
            ...
            cfg['num_features'] = 1280
    elif variant.startswith('se_tselecsls42'):
        cfg['block'] = SelecSLSBlock
        # Define configuration of the network after the initial neck
        cfg['features'] = [
            # in_chs, skip_chs, mid_chs, out_chs, is_first, stride
        ...
        if variant == 'se_tselecsls42b':
            ...
            cfg['num_features'] = 1280
    elif variant.startswith('se_tselecsls60'):
        cfg['block'] = SelecSLSBlock
        # Define configuration of the network after the initial neck
        cfg['features'] = [
            # in_chs, skip_chs, mid_chs, out_chs, is_first, stride
    ...
    model = TSelecSLS(cfg, **model_kwargs)
...
@register_model
def tselecsls42(pretrained=False, **kwargs):
    """Constructs a tselecSLS42 model.
    """
    return _create_model('tselecsls42', pretrained, kwargs)


@register_model
def tselecsls42b(pretrained=False, **kwargs):
    """Constructs a tselecSLS42_B model.
    """
    return _create_model('tselecsls42b', pretrained, kwargs)


@register_model
def tselecsls60(pretrained=False, **kwargs):
    """Constructs a tselecSLS60 model.
    """
    return _create_model('tselecsls60', pretrained, kwargs)


@register_model
def tselecsls60b(pretrained=False, **kwargs):
    """Constructs a tselecSLS60_B model.
    """
    return _create_model('tselecsls60b', pretrained, kwargs)

@register_model
def se_tselecsls42(pretrained=False, **kwargs):
    """Constructs a se_tselecSLS42 model.
    """
    return _create_model('se_tselecsls42', pretrained, kwargs)


@register_model
def se_tselecsls42b(pretrained=False, **kwargs):
    """Constructs a se_tselecSLS42_B model.
    """
    return _create_model('se_tselecsls42b', pretrained, kwargs)


@register_model
def se_tselecsls60(pretrained=False, **kwargs):
    """Constructs a se_tselecSLS60 model.
    """
    return _create_model('se_tselecsls60', pretrained, kwargs)


@register_model
def se_tselecsls60b(pretrained=False, **kwargs):
    """Constructs a se_tselecSLS60_B model.
    """
    return _create_model('se_tselecsls60b', pretrained, kwargs)
